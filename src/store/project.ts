...
export class ProjectRepo{
  ...
  async createProject(user: User, request: CreateProjectRequest): Promise<Result<Project>> {
  ...
  async updateProject(user: User, request: Partial<Project>): Promise<Result<Project>> {
